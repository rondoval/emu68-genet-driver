...
OBJS := device.o device_beginio.o device_abortio.o devtree.o unit.o unit_task.o unit_commands.o unit_io.o genet/bcmgenet.o genet/bcm_gpio.o genet/phy.o genet/phy_interface.o device_end.o
OBJDIR := Build
